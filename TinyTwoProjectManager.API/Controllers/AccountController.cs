...
using TinyTwoProjectManager.API;
using TinyTwoProjectManager.API.Results;
using TinyTwoProjectManager.Models;
using TinyTwoProjectManager.Models.BindingModels;
using TinyTwoProjectManager.Models.DTOs;
...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(ApplicationUserManager userService, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {
